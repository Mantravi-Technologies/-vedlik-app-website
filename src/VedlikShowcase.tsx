    ...
    <div ref={containerRef} className="h-screen w-full overflow-hidden overscroll-none touch-none bg-[#000] text-white">
      ...
      <main className="h-screen w-full relative overflow-hidden">
        <div ref={sectionsWrapperRef} className="w-full absolute inset-0 will-change-transform" style={{ height: `${totalSections * 100}dvh` }}>
          ...
          />
          <section className="relative h-screen min-h-[100dvh] flex items-center border-t border-white/[0.08] bg-[#000] px-4 sm:px-6 md:px-10 lg:px-12 pt-0 md:pt-0 pb-20 sm:pb-24 md:pb-0 overflow-hidden">
            <img
            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-[1.25fr_1fr] gap-10 md:gap-14 items-start">
              <div>
                <p className="text-[#2DD4BF] text-xs sm:text-sm tracking-[0.14em] uppercase">Why Vedlik</p>
                <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white leading-[0.95]">
              ...
              <div className="border-l border-white/[0.12] pl-5 sm:pl-6 md:pl-8">
          ...
          <section className="h-screen min-h-[100dvh] flex items-start md:items-center border-t border-white/[0.08] bg-[#0a0a0a] px-4 sm:px-6 md:px-10 lg:px-12 pt-16 sm:pt-20 md:pt-0 pb-20 sm:pb-24 md:pb-0">
            <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-6 md:gap-12 items-start md:items-center">
              <div>
              <p className="text-[#2DD4BF] text-xs sm:text-sm tracking-[0.14em] uppercase">Core Features</p>
              <h2 className="mt-2 sm:mt-3 text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white leading-[0.95]">
                Four ways to read smarter.
              </h2>
              <div className="mt-5 sm:mt-8 divide-y divide-white/[0.12] border-t border-b border-white/[0.12]">
                <div className="py-3 sm:py-5 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-2 sm:gap-3 md:gap-6">
                  <p className="text-white/45 text-xs sm:text-sm tracking-[0.08em] uppercase">01 — Intelligence Flip</p>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">Tap a card and flip into extracted metrics: model size, valuation, hardware footprint, and licensing.</p>
                </div>
                <div className="py-3 sm:py-5 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-2 sm:gap-3 md:gap-6">
                  <p className="text-white/45 text-xs sm:text-sm tracking-[0.08em] uppercase">02 — Knowledge Engine</p>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">Highlight a technical term and get a plain-language definition without leaving the feed.</p>
                </div>
                <div className="py-3 sm:py-5 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-2 sm:gap-3 md:gap-6">
                  <p className="text-white/45 text-xs sm:text-sm tracking-[0.08em] uppercase">03 — Anti-Fluff Feed</p>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">Short summaries that preserve the signal and remove repetitive narrative.</p>
                </div>
                <div className="py-3 sm:py-5 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-2 sm:gap-3 md:gap-6">
                  <p className="text-white/45 text-xs sm:text-sm tracking-[0.08em] uppercase">04 — Intel Library</p>
                  <p className="text-white/80 text-sm sm:text-base leading-relaxed">Bookmark key updates and build a personal research trail you can return to fast.</p>
                </div>
              </div>
              </div>
              <div className="w-full flex items-start justify-center md:justify-end -mt-12 sm:-mt-3 md:mt-0 pt-0">
                <img
                  src="/images/vedlik_mockup_2.png"
                  alt="Vedlik app mockup"
                  className="w-auto h-[46vh] sm:h-[58vh] md:h-[78vh] lg:h-[84vh] max-w-full object-contain object-center select-none pointer-events-none mix-blend-screen"
                  draggable={false}
                />
              </div>
            </div>
          ...
          <section className="relative h-screen min-h-[100dvh] flex items-center border-t border-white/[0.08] bg-[#000] px-4 sm:px-6 md:px-10 lg:px-12 pt-0 md:pt-0 pb-20 sm:pb-24 md:pb-0 overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl w-full">
              ...
              <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white leading-[0.95] max-w-4xl">
              ...
              <div className="mt-7 sm:mt-9 flex flex-row items-center gap-3 sm:gap-5">
