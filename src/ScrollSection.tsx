...
export default function ScrollSection({
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full flex flex-col md:flex-row md:items-center md:justify-between gap-5 sm:gap-8 md:gap-12 px-4 sm:px-6 md:px-10 lg:px-12 pt-14 pb-12 sm:pt-16 sm:pb-14 md:py-20 h-[100dvh] min-h-[100dvh] bg-[#000] border-b border-white/[0.08] overflow-hidden snap-start snap-always"
    >
      ...
      <div className="relative order-1 md:order-1 z-10 flex flex-col justify-center md:w-[46%] lg:max-w-xl shrink-0 min-h-[20vh] sm:min-h-[24vh] md:min-h-[240px]">
        <div ref={text1Ref} className="absolute inset-0 flex flex-col justify-center items-center md:items-start text-center md:text-left opacity-100 md:translate-x-10 lg:translate-x-14 translate-y-0 sm:translate-y-3 md:translate-y-0">
          <h1 className="text-[2.2rem] leading-[0.94] sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white">
            Signals, Decoded.
          </h1>
          <p className="mt-2.5 sm:mt-4 md:mt-5 text-white/70 text-base sm:text-xl md:text-2xl max-w-lg mx-auto md:mx-0">
            Cut through the noise. One feed, one truth.
          </p>
          <div className="mt-4 sm:mt-6 w-full flex justify-center md:justify-start -translate-x-1 sm:translate-x-0 md:translate-x-0">
            <a
              href="#"
        ...
        <div ref={text2Ref} className="absolute inset-0 flex flex-col justify-center items-center md:items-start text-center md:text-left opacity-0 md:translate-x-10 lg:translate-x-14 translate-y-0 sm:translate-y-3 md:translate-y-0">
          <h1 className="text-[2.2rem] leading-[0.94] sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white">
            Read what matters.
          </h1>
          <p className="mt-2.5 sm:mt-4 md:mt-5 text-white/70 text-base sm:text-xl md:text-2xl max-w-lg mx-auto md:mx-0">
      ...
      <div className="order-2 md:order-2 flex-1 z-10 flex items-center justify-center md:justify-center md:w-[58%] min-h-[45vh] sm:min-h-[50vh] md:min-h-0">
        <PhoneMockup
          phoneRef={phoneRef}
